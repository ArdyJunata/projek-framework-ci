                        ...
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span id="user" class="count">0</span></div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span id="admin" class="count">0</span></div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-five">
                            ...
                            <div class="stat-content">
                                <div class="text-left dib">
                                    <div class="stat-text"><span id="product" class="count">0</span></div>
...
<script>
    ...
    const getProductCount = async () => {
        let res = await fetch(`http://localhost:3000/product/count/1`);
        return await res.json();
    }

    const changeCount = (users, admins, products) => {
        let data = users;
        let data2 = admins;
        let data3 = products;
        ...
        product.innerHTML = data3.data[0].count;
    }

    setInterval(async () => {
        let user = await getCount(1);
        let admin = await getCount(2);
        let product = await getProductCount();
        changeCount(user, admin, product);
    }, 1000);
</script>