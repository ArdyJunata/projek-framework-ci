                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="card-body">
                                                    ...
                                                    <div id="pay-invoice">
                                                        <div class="card-body">
                                                            <form method="post" id="addUser" novalidate="novalidate">
                                                                ...
                                                                <div class="form-group has-success">
                                                                    ...
                                                                    <input id="email" name="email" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name">
                                                                    <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="cc-number" class="control-label mb-1">Address</label>
                                                                    <input id="address" name="address" type="tel" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="city" name="city" type="tel" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year">
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input id="province" name="province" type="tel" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div>
